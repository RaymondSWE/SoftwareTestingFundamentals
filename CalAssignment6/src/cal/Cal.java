...
// Can be run in Eclipse as a Java Application or a JUnit Test
...
//***********************************************************
   ...
   else
   {
      ...
      if ((m4 != 0) || ((m100 == 0) && (m400 != 0)))
    	  // ROR_1: ((m4 != 0) || ((m100 == 0) && (m400 == 0)))	  
          // ROR_2: if ((m4 != 0) || ((m100 == 0) && (m400 <= 0)))	  
          // ROR_3: if ((m4 != 0) || ((m100 == 0) && (m400 < 0)))	  
          // ROR_4: if ((m4 != 0) || ((m100 == 0) && (m400 >= 0)))	  
          // ROR_5: if ((m4 != 0) || ((m100 == 0) && (m400 > 0)))	  
          // ROR_6: if ((m4 != 0) || ((m100 == 0) && (true)))	  
          // ROR_7: if ((m4 != 0) || ((m100 == 0) && (false)))	  
         daysIn[2] = 28;
      else
         daysIn[2] = 29;
      ...
      for (int i = month1 + 1; i <= month2-1; i++)
        ...
        // AOR_1 numDays = daysIn[i] - numDays;
      	// AOR_2 numDays = daysIn[i] * numDays;
   	 	// AOR_3 numDays = daysIn[i] / numDays;
      	// AOR_4 numDays = daysIn[i];
      	// AOR_5 numDays = numDays;
      	// AOR_6 numDays = daysIn[i] % numDays;
   }
   return (numDays);
}
